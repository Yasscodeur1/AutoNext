  ...
  return (
    <div className="text-center m-20">
      <div className="">
        ...
        <p>
          Wie zijn we CarDealer.be is een 100% Belgisch en nationaal platform
          dat zich heeft gepositioneerd als voorkeurspartner voor handelaars en
      ...
      <div className="flex flex-wrap items-center gap-10 mt-20 xl:flex-nowrap">
        <div className="w-150 ">
          ...
          <p>
            ...
            Verken gedetailleerde profielen, lees beoordelingen van andere
            kopers en neem weloverwogen beslissingen over je volgende
            autoaankoop. Met CarDealer.be wordt het kopen van een auto een
            transparante en probleemloze ervaring.
          </p>
        </div>
        <Image
